...
One scan → 90 artifacts across 18 programs, ready in seconds:
...
| Connect AI tools (MCP) | **MCP** | `mcp-config.json`, `mcp-registry-metadata.json`, `protocol-spec.md`, `spec.types.ts`, `mcp/README.md`, `capability-registry.json`, `server-manifest.yaml` |
