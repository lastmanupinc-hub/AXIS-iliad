...
export interface Product {
  ...
  gate_note?: string;
  /**
   * What `billing` BECOMES once recurring billing goes live (2026-08-15).
   *
   * `billing` above must always describe what happens TODAY. It previously said
   * "recurring" for 17 products while TERMS_OF_SERVICE.md said "Payment for a
   * paid tier is a single, one-time charge ... a purchase does not
   * automatically renew" — a contradiction that was harmless only because
   * nothing rendered the field, and would have shipped as 17 false pricing
   * claims the moment spoke_05 generated a landing page per product.
   *
   * Splitting the two keeps today's value true without losing the intent, so
   * nobody has to reconstruct which products flip on the gate date.
   * billing-claim-honesty.test.ts enforces both halves.
   */
  billing_at_gate?: "recurring";
}

export const PRODUCT_REGISTRY: Record<string, Product> = {
  skills: {
    id: "skills", name: "Skills", subdomain: "skills.trustfabric.ai",
    programs: ["skills"], price_usd: 9, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  mcp: {
    id: "mcp", name: "MCP", subdomain: "mcp.trustfabric.ai",
    programs: ["mcp"], price_usd: 29, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  deploy: {
    id: "deploy", name: "Deploy", subdomain: "deploy.trustfabric.ai",
    programs: ["deploy"], price_usd: 19, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  closer: {
  ...
  theme: {
    ...
    programs: ["theme"], price_usd: 19, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  frontend: {
    id: "frontend", name: "Frontend", subdomain: "frontend.trustfabric.ai",
    programs: ["frontend"], price_usd: 19, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  seo: {
    id: "seo", name: "SEO", subdomain: "seo.trustfabric.ai",
    programs: ["seo"], price_usd: 19, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  debug: {
    id: "debug", name: "Debug", subdomain: "debug.trustfabric.ai",
    programs: ["debug"], price_usd: 15, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  optimization: {
    id: "optimization", name: "Optimization", subdomain: "optimization.trustfabric.ai",
    programs: ["optimization"], price_usd: 29, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  search: {
  ...
  artifacts: {
    ...
    programs: ["artifacts"], price_usd: 29, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  superpowers: {
  ...
  brand: {
    ...
    programs: ["brand"], price_usd: 15, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  marketing: {
    id: "marketing", name: "Marketing", subdomain: "marketing.trustfabric.ai",
    programs: ["marketing"], price_usd: 19, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  notebook: {
    id: "notebook", name: "Notebook", subdomain: "notebook.trustfabric.ai",
    programs: ["notebook"], price_usd: 15, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  obsidian: {
  ...
  canvas: {
    ...
    programs: ["canvas"], price_usd: 15, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
  remotion: {
    id: "remotion", name: "Remotion", subdomain: "remotion.trustfabric.ai",
    programs: ["remotion"], price_usd: 29, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  ...
  algorithmic: {
    ...
    programs: ["algorithmic"], price_usd: 19, billing: "one_time", billing_at_gate: "recurring", tier_min: "paid",
  },
};
