// Vendored from @axis/context-engine (packages/context-engine/src/engine.ts).
// Imports rewired to the local vendored modules. One deliberate change:
// generated_at is a fixed constant so iliad output is byte-deterministic.

import type { SnapshotRecord } from "../snapshots/types.js";
import type { ParseResult } from "../repo-parser/types.js";
import { parseRepo } from "../repo-parser/parser.js";
import type { ContextMap, RepoProfile } from "./types.js";

/** Deterministic placeholder — iliad never embeds wall-clock timestamps in output. */
