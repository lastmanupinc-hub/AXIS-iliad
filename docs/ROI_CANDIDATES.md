...
> secrets — annotated; the deletion itself stays an owner call, P8). The remaining three — 0.1
> alerting, 0.3 attestation, 0.5 code-sandbox — are **all owner-gated**: they need a webhook URL,
> a choice of remedy, and a hosting decision respectively. No engineering blocks them.
