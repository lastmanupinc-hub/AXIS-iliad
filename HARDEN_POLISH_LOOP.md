...
|---|---|---|---|
| H0.1–H0.10 | Hygiene | H0.1 + H0.3 + H0.4 DONE (all red-green demonstrated); H0.2 waits on H2.1; rest pending | see PROGRESS |
...
| 2026-07-11 | H0.4 | Stripe-Version 2026-06-24.dahlia pinned on all 4 outbound call sites (stripe.ts x2, network-token, dispute-clients); webhook handlers dual-read Basil+ shapes (item-level periods, invoice parent.subscription_details) with legacy fallback; 6 reds demonstrated first | see commit |
