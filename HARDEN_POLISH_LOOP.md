...
| RT.1–RT.9 | Wave-0 red-team remediation (operator-commissioned, 7-lens adversarial workflow: 2 critical + 3 high + 4 medium confirmed, 3 refuted) | RT.1-RT.3 DONE (findings #1,#2,#5,#3); RT.4-RT.9 in progress (findings #4,#6,#7,#8,#9 + funnel.ts H2.5 gap) | see PROGRESS |
