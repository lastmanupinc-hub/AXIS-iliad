...
| RT.1–RT.9 | Wave-0 red-team remediation (operator-commissioned, 7-lens adversarial workflow: 2 critical + 3 high + 4 medium confirmed, 3 refuted) | RT.1 (idempotency claim, CRITICAL) DONE; RT.2–RT.9 in progress | see PROGRESS |
