...
| `AppHandle` | interface | 3 | WebPage |
| `Route` | interface | 4 | WebPage |
| `CliArgs` | interface | 5 | WebPage |
| `AxisConfig` | interface | 2 | WebPage |
| `RunResult` | interface | 4 | WebPage |
| `ScanResult` | interface | 3 | WebPage |
| `WriteResult` | interface | 3 | WebPage |
...
| `apps/web/src/pages/UploadPage.tsx` | export function UploadPage({ ... } | 520 |
