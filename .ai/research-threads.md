...
- External dependency count: 19 — is this sustainable?
...
The project defines **131 domain models**. High field-count models may need documentation or decomposition:
...
- **`apps/api/src/server.ts`** — 234 lines, exports: export const app = ...
- **`apps/web/src/App.tsx`** — 286 lines, exports: export function App() { ... }
- **`apps/web/src/main.tsx`** — 11 lines, exports: default
- **`packages/context-engine/src/index.ts`** — 3 lines, exports: export type { ... }, export { ... }
- **`packages/generator-core/src/index.ts`** — 20 lines, exports: export type { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }, export { ... }
