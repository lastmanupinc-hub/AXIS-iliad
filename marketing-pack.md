...
**Model**: Freemium SaaS — Free tier (3 programs, 15 generators) → Paid tiers (20 programs, 141 generators; Starter $29 / Pro $99 / Growth $299 per month)
...
| Code Intelligence | Sourcegraph, Codeium, Codacy | $500M | **Deeper output** — 141 artifacts vs. search results |
...
|-----------|---------|---------------|
| 141 generators across 20 programs | apps/api/src/counts.ts canonical counts | High — breadth creates switching cost |
...
|---------|-------------|-------------|-----------|-------|
| Repo analysis | ✅ 141 artifacts | ✅ Search + navigation | ✅ Quality gates | ✅ Task completion |
...
| 2 | "141 Artifacts From One Upload: How Axis' Iliad Works" | Technical deep-dive | Blog, YouTube | Product understanding |
...
| 10 | What the full 141-generator catalog looks like | Preview of paid-tier outputs: Theme, Brand, Marketing. Show examples. |
...
| Day | Subject | Content |
|-----|---------|---------|
| 0 | You just unlocked the full catalog | Welcome to Pro. Guide to all 20 programs and 141 generators. |
...
### Hero Section
**Headline**: 141 generators. 20 programs. One upload.
...
| 2 | 141 artifacts, zero effort | From architecture diagrams to marketing copy to design tokens — all generated from a single snapshot of your repo. |
