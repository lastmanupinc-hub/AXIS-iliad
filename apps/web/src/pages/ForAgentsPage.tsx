...
export function ForAgentsPage() {
  ...
  const claudePrompt = `You have access to AXIS Toolbox â€” a codebase intelligence API.
...
challenge, complete the Stripe payment for $0.50, and retry with the credential.`;
  ...
  const cursorPrompt = `# AXIS Toolbox â€” MCP Integration
# Endpoint: ${API_BASE}/mcp
# Transport: Streamable HTTP (MCP 2025-03-26 spec)
# Auth: Authorization: Bearer $AXIS_API_KEY

# When to call AXIS Toolbox:
...
# Auth required, $0.50/run via MPP if quota exceeded`;
  ...
  const swarmPrompt = `{
  "tool_name": "axis_toolbox",
  "display_name": "AXIS Toolbox â€” Codebase Intelligence",
...
# Generated by AXIS Toolbox â€” agentic-purchasing program
