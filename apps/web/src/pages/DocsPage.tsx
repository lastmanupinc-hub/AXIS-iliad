...
const PROGRAM_DOCS: ProgramDoc[] = [
  ...
  },
  {
    ...
    outputFiles: ["mcp-config.json", "mcp-registry-metadata.json", "protocol-spec.md", "spec.types.ts", "mcp/README.md", "connector-map.yaml", "capability-registry.json", "server-manifest.yaml"],
