...
const PROGRAM_DOCS: ProgramDoc[] = [
  ...
  },
  {
    ...
    outputFiles: [".ai/seo-rules.md", "schema-recommendations.json", "route-priority-map.md", "content-audit.md", "meta-tag-audit.json", "seo-head-tags.html"],
  ...
  },
  {
    ...
    outputFiles: ["brand-guidelines.md", "voice-and-tone.md", "content-constraints.md", "messaging-system.yaml", ".vale.ini", "styles/AXIS/ForbiddenPatterns.yml", "styles/AXIS/PreferredTerms.yml", "channel-rulebook.md"],
  ...
  },
  {
    ...
    tier: "pro", generatorCount: 10,
    endpoints: ["POST /v1/superpowers/generate", "POST /v1/superpowers/export"],
    outputFiles: ["superpower-pack.md", "workflow-registry.json", "test-generation-rules.md", "refactor-checklist.md", "automation-pipeline.yaml", "verify.sh", "verify-full.sh", ".githooks/pre-push", "redundancy-sweep.mjs", "redundancy-sweep-playbook.md"],
  ...
  },
  {
    ...
    outputFiles: ["canvas-spec.json", "social-pack.md", "poster-layouts.md", "asset-guidelines.md", "architecture-diagram.d2", "brand-board.md"],
