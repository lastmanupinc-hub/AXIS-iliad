...
const QA_ITEMS: QAItem[] = [
  ...
  // API
  {
    ...
    answer: `The production API runs at ${PROD_API_BASE} with all endpoints prefixed under /v1. For example: POST /v1/snapshots to create a snapshot, GET /v1/health for status checks. There are ${ENDPOINT_COUNT} endpoints covering snapshots, programs, generated files, search, accounts, API keys, team seats, billing, webhooks, and agentic commerce.`,
  },
  {
    category: "api",
  ...
  },
  {
    ...
    answer: "Limits are tracked with credits and request throttles. Free starts with 10,000 monthly credits. Starter includes 75,000 credits, Pro includes 300,000 credits, and Growth includes 1,200,000 credits. Overage is billed at $0.0018 per credit and requests continue instead of hard-failing when possible. Referral rewards lower your effective dollars per call as referrals grow (up to 0.02% benefit).",
  },
  {
    category: "api",
  ...
  },
  {
    ...
    answer: `Growth is $299/month with 1,200,000 monthly credits and is designed for teams and production workloads. It includes all ${PROGRAM_COUNT} programs plus higher operational limits and support options.`,
  },
  {
    category: "billing",
