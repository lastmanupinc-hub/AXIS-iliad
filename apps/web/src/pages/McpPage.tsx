...
// is fetched live: the manifest (GET /v1/mcp/server.json), the full 36-tool
...
// ─── 6. Live probe-intent demo ─────────────────────────────────────
// POST /probe-intent — public, no auth, no repo analysis triggered (pure
// keyword routing over the submitted text), so this box carries none of the
// anonymous-cost-gate concerns that guard /v1/analyze.

function ProbeIntentDemo() {
