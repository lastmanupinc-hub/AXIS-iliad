      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          {[
            ...
            { label: "Referral Rewards", desc: "Token-side only: usage per call decreases as referrals grow (up to 0.02%). Cash pricing stays the same. Resets each billing cycle." },
          ].map(item => (
